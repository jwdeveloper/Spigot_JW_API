...
public class BetterCommandDynamic extends BetterCommand
{

    private CommandEvent commandEvent;

    private boolean runByConsle =false;
    public BetterCommandDynamic(String name, CommandEvent commandEvent)
    {
        super(name,false);
        this.commandEvent = commandEvent;
    }
    public BetterCommandDynamic(String name, CommandEvent commandEvent, boolean runByConsle)
    {
